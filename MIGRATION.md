...
Given the foundational changes and large differences in the Public API in the new libraries, we found the best way to cover every detail is to go through the [documentation](https://docs.notifica.re/sdk/v3/ionic-native/implementation) for each of the modules you want to include and adjust accordingly.
